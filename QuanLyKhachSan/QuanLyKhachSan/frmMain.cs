...
namespace QuanLyKhachSan
{
    public partial class frmMain : Form
    {
        ...
        void PhanQuyen()
        {
            ...
            this.Text += $" (Chào mừng: {tenHienThi})";

            // Nếu KHÔNG PHẢI là "Quản lý" 
            if (loaiTK != "Quản lý")
            {
                // Vô hiệu hóa (khóa) các menu
        ...
        {
            int selectedLoaiPhongID = Convert.ToInt32(cboLoaiPhong.SelectedValue);
        ...
        private void itemThemDichVu_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Mở form Thêm Dịch Vụ cho phòng " + idPhong);
